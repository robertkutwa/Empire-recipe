...
export default function AddRecipe() {
  ...
  const handleNutritionalChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const { name, value } = e.target;
    setNutritionalInfo((prev) => ({ ...prev, [name]: value }));
  };
      ...
      const recipeData = {
        ...
        nutritionalInfo: {
          calories: nutritionalInfo.calories
            ? parseInt(nutritionalInfo.calories)
            : undefined,
          protein: nutritionalInfo.protein
            ? parseInt(nutritionalInfo.protein)
            : undefined,
          carbs: nutritionalInfo.carbs
            ? parseInt(nutritionalInfo.carbs)
            : undefined,
          fat: nutritionalInfo.fat ? parseInt(nutritionalInfo.fat) : undefined,
        },
      };
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add nutritional facts per serving
              </CardDescription>
            </CardHeader>
            <CardContent>
