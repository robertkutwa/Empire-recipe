...
import { sampleRecipes } from "../data/sampleData.js";

// Mock database - In a real app, you'd use a proper database
const recipes = [...sampleRecipes]; // Initialize with sample data
const userRecipeInteractions = [];
...
const getUserInteractionsForRecipe = (userId, recipeId) => {
...
export const handleGetRecipes = (req, res) => {
  try {
...
export const handleGetRecipe = (req, res) => {
  try {
    const { id } = req.params;
...
export const handleCreateRecipe = (req, res) => {
  try {
    const user = req.user;
...
export const handleUpdateRecipe = (req, res) => {
  try {
    const user = req.user;
    const { id } = req.params;
...
export const handleDeleteRecipe = (req, res) => {
  try {
    const user = req.user;
    const { id } = req.params;
...
export const handleToggleWantToTry = (req, res) => {
  try {
    const user = req.user;
    const { id } = req.params;
